...
1.1 - Estilização do CSS na página publica e do admin
1.2 - Criação de uma página: Cardápio
1.3 - Criação de uma página admin: Cardápio
1.4 - Criação de uma página admin: pedidos
2 - Criação de um CRUDE de cardápio
3 - Criação de um CRUDE de pedidos

O resto, você vai ter que navegar e descobrir, n vai ter graça contar tudo
